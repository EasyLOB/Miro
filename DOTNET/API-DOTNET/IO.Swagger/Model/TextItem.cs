...
namespace IO.Swagger.Model
{
        ...
        public partial class TextItem :  IEquatable<TextItem>, IValidatableObject
    {
        ...
        public TextItem(long? id = default(long?), TextData data = default(TextData), TextStyle style = default(TextStyle), Position position = default(Position), Geometry geometry = default(Geometry), DateTime? createdAt = default(DateTime?), CreatedBy createdBy = default(CreatedBy), DateTime? modifiedAt = default(DateTime?), ModifiedBy modifiedBy = default(ModifiedBy), ParentLinksEnvelope parent = default(ParentLinksEnvelope), WidgetLinks links = default(WidgetLinks), string type = default(string))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for TextItem and cannot be null");
            }
            else
            {
                this.Type = type;
