...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModifiedBy :  IEquatable<ModifiedBy>, IValidatableObject
    {
        /// <summary>
        ...
        public ModifiedBy(string id = default(string), string type = default(string))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as ModifiedBy);
        }

        /// <summary>
        /// Returns true if ModifiedBy instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifiedBy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifiedBy input)
        {
            if (input == null)
                return false;
