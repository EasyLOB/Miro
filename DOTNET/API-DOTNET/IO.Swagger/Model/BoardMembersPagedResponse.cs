...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BoardMembersPagedResponse :  IEquatable<BoardMembersPagedResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BoardMembersPagedResponse" /> class.
        /// </summary>
        ...
        public BoardMembersPagedResponse(List<BoardMember> data = default(List<BoardMember>), long? total = default(long?), int? size = default(int?), int? offset = default(int?), int? limit = default(int?), PageLinks links = default(PageLinks), string type = default(string))
        {
            this.Data = data;
            this.Total = total;
            this.Size = size;
        ...
        public List<BoardMember> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BoardMembersPagedResponse {\n");
        ...
        {
            return this.Equals(input as BoardMembersPagedResponse);
        }

        /// <summary>
        /// Returns true if BoardMembersPagedResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BoardMembersPagedResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BoardMembersPagedResponse input)
        {
            if (input == null)
                return false;
