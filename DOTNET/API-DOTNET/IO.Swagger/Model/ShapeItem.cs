...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ShapeItem :  IEquatable<ShapeItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShapeItem" /> class.
        /// </summary>
        ...
        public ShapeItem(long? id = default(long?), ShapeData data = default(ShapeData), ShapeStyle style = default(ShapeStyle), Position position = default(Position), Geometry geometry = default(Geometry), DateTime? createdAt = default(DateTime?), CreatedBy createdBy = default(CreatedBy), DateTime? modifiedAt = default(DateTime?), ModifiedBy modifiedBy = default(ModifiedBy), ParentLinksEnvelope parent = default(ParentLinksEnvelope), WidgetLinks links = default(WidgetLinks), string type = default(string))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ShapeItem and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as ShapeItem);
        }

        /// <summary>
        /// Returns true if ShapeItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ShapeItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShapeItem input)
        {
            if (input == null)
                return false;
