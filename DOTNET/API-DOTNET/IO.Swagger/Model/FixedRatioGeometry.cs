...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FixedRatioGeometry :  IEquatable<FixedRatioGeometry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FixedRatioGeometry" /> class.
        /// </summary>
        ...
        public FixedRatioGeometry(double? height = default(double?), double? rotation = default(double?), double? width = default(double?))
        {
            this.Height = height;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FixedRatioGeometry {\n");
        ...
        {
            return this.Equals(input as FixedRatioGeometry);
        }

        /// <summary>
        /// Returns true if FixedRatioGeometry instances are equal
        /// </summary>
        /// <param name="input">Instance of FixedRatioGeometry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FixedRatioGeometry input)
        {
            if (input == null)
                return false;
