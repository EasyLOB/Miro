...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AppCardItem :  IEquatable<AppCardItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppCardItem" /> class.
        /// </summary>
        ...
        public AppCardItem(long? id = default(long?), AppCardData data = default(AppCardData), AppCardStyle style = default(AppCardStyle), Position position = default(Position), Geometry geometry = default(Geometry), DateTime? createdAt = default(DateTime?), CreatedBy createdBy = default(CreatedBy), DateTime? modifiedAt = default(DateTime?), ModifiedBy modifiedBy = default(ModifiedBy), ParentLinksEnvelope parent = default(ParentLinksEnvelope), WidgetLinks links = default(WidgetLinks), string type = default(string))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for AppCardItem and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public AppCardData Data { get; set; }
        ...
        {
            return this.Equals(input as AppCardItem);
        }

        /// <summary>
        /// Returns true if AppCardItem instances are equal
        /// </summary>
        /// <param name="input">Instance of AppCardItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppCardItem input)
        {
            if (input == null)
                return false;
