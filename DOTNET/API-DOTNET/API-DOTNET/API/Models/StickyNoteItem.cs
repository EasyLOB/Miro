...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StickyNoteItem :  IEquatable<StickyNoteItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StickyNoteItem" /> class.
        /// </summary>
        ...
        public StickyNoteItem(long? id = default(long?), StickyNoteData data = default(StickyNoteData), StickyNoteStyle style = default(StickyNoteStyle), Position position = default(Position), Geometry geometry = default(Geometry), DateTime? createdAt = default(DateTime?), CreatedBy createdBy = default(CreatedBy), DateTime? modifiedAt = default(DateTime?), ModifiedBy modifiedBy = default(ModifiedBy), ParentLinksEnvelope parent = default(ParentLinksEnvelope), WidgetLinks links = default(WidgetLinks), string type = default(string))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for StickyNoteItem and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StickyNoteItem {\n");
        ...
        {
            return this.Equals(input as StickyNoteItem);
        }

        /// <summary>
        /// Returns true if StickyNoteItem instances are equal
        /// </summary>
        /// <param name="input">Instance of StickyNoteItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StickyNoteItem input)
        {
            if (input == null)
                return false;
