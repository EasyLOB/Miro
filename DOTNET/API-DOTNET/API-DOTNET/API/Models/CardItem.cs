...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CardItem :  IEquatable<CardItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CardItem" /> class.
        /// </summary>
        ...
        public CardItem(long? id = default(long?), CardData data = default(CardData), CardStyle style = default(CardStyle), Position position = default(Position), Geometry geometry = default(Geometry), DateTime? createdAt = default(DateTime?), CreatedBy createdBy = default(CreatedBy), DateTime? modifiedAt = default(DateTime?), ModifiedBy modifiedBy = default(ModifiedBy), ParentLinksEnvelope parent = default(ParentLinksEnvelope), WidgetLinks links = default(WidgetLinks), string type = default(string))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for CardItem and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as CardItem);
        }

        /// <summary>
        /// Returns true if CardItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CardItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardItem input)
        {
            if (input == null)
                return false;
