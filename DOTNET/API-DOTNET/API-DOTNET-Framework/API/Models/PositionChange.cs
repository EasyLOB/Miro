...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PositionChange :  IEquatable<PositionChange>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PositionChange" /> class.
        /// </summary>
        ...
        public PositionChange(OriginEnum? origin = OriginEnum.Center, double? x = 0, double? y = 0)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PositionChange {\n");
        ...
        {
            return this.Equals(input as PositionChange);
        }

        /// <summary>
        /// Returns true if PositionChange instances are equal
        /// </summary>
        /// <param name="input">Instance of PositionChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PositionChange input)
        {
            if (input == null)
                return false;
