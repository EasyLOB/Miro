...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ImageItem :  IEquatable<ImageItem>, IValidatableObject
    {
        /// <summary>
        ...
        public ImageItem(long? id = default(long?), ImageData data = default(ImageData), Position position = default(Position), Geometry geometry = default(Geometry), DateTime? createdAt = default(DateTime?), CreatedBy createdBy = default(CreatedBy), DateTime? modifiedAt = default(DateTime?), ModifiedBy modifiedBy = default(ModifiedBy), ParentLinksEnvelope parent = default(ParentLinksEnvelope), WidgetLinks links = default(WidgetLinks), string type = default(string))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ImageItem and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as ImageItem);
        }

        /// <summary>
        /// Returns true if ImageItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ImageItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImageItem input)
        {
            if (input == null)
                return false;
