...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BoardPolicy :  IEquatable<BoardPolicy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BoardPolicy" /> class.
        /// </summary>
        /// <param name="permissionsPolicy">permissionsPolicy.</param>
        /// <param name="sharingPolicy">sharingPolicy.</param>
        public BoardPolicy(BoardPermissionsPolicy permissionsPolicy = default(BoardPermissionsPolicy), BoardSharingPolicy sharingPolicy = default(BoardSharingPolicy))
        {
        ...
        public BoardSharingPolicy SharingPolicy { get; set; }
        ...
        {
            return this.Equals(input as BoardPolicy);
        }

        /// <summary>
        /// Returns true if BoardPolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of BoardPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BoardPolicy input)
        {
            if (input == null)
                return false;
